##Once the mongodb connection is establish with the mongodb 
##Then this file(fetch_data) will export the data from the database as we have created before
import sys
import pandas as pd
import numpy as np
...
class FetchData:
    ...
    def export_collection_as_dataframe(self, collection_name: str, database_name: Optional[str] = None) -> pd.DataFrame:
        ...
        try:
            ...
            if "policy_id" in df.columns.to_list():
